...
#define ST_DAM       m_st->at(15)
#define ST_ARREST    m_st->at(16)
...
#define PAR_VEGF           m_param->at(9)
#define PAR_VEGF_THRES     m_param->at(10)
#define PAR_ALPHA          m_param->at(11)
#define PAR_ALPHA_FIB      m_param->at(12)
#define PAR_ALPHA_G1       m_param->at(13)
#define PAR_ALPHA_S        m_param->at(14)
#define PAR_ALPHA_G2       m_param->at(15)
#define PAR_ALPHA_M        m_param->at(16)
#define PAR_ALPHA_G0       m_param->at(17)
#define PAR_ALPHA_NORM_VES m_param->at(18)
#define PAR_ALPHA_TUM_VES  m_param->at(19)
#define PAR_BETA           m_param->at(20)
#define PAR_BETA_FIB       m_param->at(21)
#define PAR_BETA_G1        m_param->at(22)
#define PAR_BETA_S         m_param->at(23)
#define PAR_BETA_G2        m_param->at(24)
#define PAR_BETA_M         m_param->at(25)
#define PAR_BETA_G0        m_param->at(26)
#define PAR_BETA_NORM_VES  m_param->at(27)
#define PAR_BETA_TUM_VES   m_param->at(28)
#define PAR_DOSE_THRES     m_param->at(29)
#define PAR_ARREST_TIME    m_param->at(30)
#define PAR_ACC_DOSE       m_param->at(31)
#define PAR_M              m_param->at(32)
#define PAR_K              m_param->at(33)
#define PAR_PO2            m_param->at(34)
#define PAR_HYP_NEC_THRES  m_param->at(35)
...
public :
    ...
    Cell(const int i, const int j, const int l,
         ...
         const double hypNecThres, Model *const parent = 0);
    virtual ~Cell();
